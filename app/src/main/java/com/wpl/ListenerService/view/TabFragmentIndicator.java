package com.wpl.ListenerService.view;
...
public class TabFragmentIndicator extends LinearLayout implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (!isClick) {
            if (positionOffsetPixels != 0) {
                int SCROLL_STATE_PRESS = 1;
                int SCROLL_STATE_UP = 2;
    ...
    public void onPageSelected(int position) {
        ((TextView) ((ViewGroup) container).getChildAt(selectedPage)).setTextColor(this.getResources().getColor(R.color.not_select));
